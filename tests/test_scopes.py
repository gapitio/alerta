...
class ScopesTestCase(unittest.TestCase):
    ...
    def test_is_in_scope(self):
        ...
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions, [Scope.admin]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions, [Scope.write]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions, [Scope.read]), False)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions, [Scope.admin_alerts]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions, [Scope.write_alerts]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions, [Scope.read_alerts]), False)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions, [Scope.write_alerts_actions]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions_ack, [Scope.admin]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions_ack, [Scope.write]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions_ack, [Scope.read]), False)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions_ack, [Scope.admin_alerts]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions_ack, [Scope.write_alerts]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions_ack, [Scope.read_alerts]), False)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions_ack, [Scope.write_alerts_actions]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions_ack, [Scope.write_alerts_actions_ack]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_alerts_actions_ack, [Scope.write_alerts_actions_unack]), False)

        self.assertEqual(Permission.is_in_scope(Scope.write_notification_rules, [Scope.admin]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_notification_rules, [Scope.write]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_notification_rules, [Scope.read]), False)
        self.assertEqual(Permission.is_in_scope(Scope.write_notification_rules, [Scope.admin_notification]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_notification_rules, [Scope.write_notification]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_notification_rules, [Scope.read_notification]), False)
        self.assertEqual(Permission.is_in_scope(Scope.write_notification_rules, [Scope.admin_notification_rules]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_notification_rules, [Scope.write_notification_rules]), True)
        self.assertEqual(Permission.is_in_scope(Scope.write_notification_rules, [Scope.read_notification_rules]), False)
        self.assertEqual(Permission.is_in_scope(Scope.write_notification_rules, [Scope.admin_notification_channels]), False)
        self.assertEqual(Permission.is_in_scope(Scope.write_notification_rules, [Scope.write_notification_channels]), False)
        self.assertEqual(Permission.is_in_scope(Scope.write_notification_rules, [Scope.read_notification_channels]), False)

        self.assertEqual(Permission.is_in_scope(Scope.read_notification_rules, [Scope.admin]), True)
        self.assertEqual(Permission.is_in_scope(Scope.read_notification_rules, [Scope.write]), True)
        self.assertEqual(Permission.is_in_scope(Scope.read_notification_rules, [Scope.read]), True)
        self.assertEqual(Permission.is_in_scope(Scope.read_notification_rules, [Scope.admin_notification]), True)
        self.assertEqual(Permission.is_in_scope(Scope.read_notification_rules, [Scope.write_notification]), True)
        self.assertEqual(Permission.is_in_scope(Scope.read_notification_rules, [Scope.read_notification]), True)
        self.assertEqual(Permission.is_in_scope(Scope.read_notification_rules, [Scope.admin_notification_rules]), True)
        self.assertEqual(Permission.is_in_scope(Scope.read_notification_rules, [Scope.write_notification_rules]), True)
        self.assertEqual(Permission.is_in_scope(Scope.read_notification_rules, [Scope.read_notification_rules]), True)
        self.assertEqual(Permission.is_in_scope(Scope.read_notification_rules, [Scope.admin_notification_channels]), False)
        self.assertEqual(Permission.is_in_scope(Scope.read_notification_rules, [Scope.write_notification_channels]), False)
        self.assertEqual(Permission.is_in_scope(Scope.read_notification_rules, [Scope.read_notification_channels]), False)
