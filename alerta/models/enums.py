...
class Scope(str):
    ...
    write_alerts_actions = 'write:alerts.actions'
    write_alerts_actions_close = 'write:alerts.actions.close'
    write_alerts_actions_open = 'write:alerts.actions.open'
    write_alerts_actions_shelve = 'write:alerts.actions.shelve'
    write_alerts_actions_unshelve = 'write:alerts.actions.unshelve'
    write_alerts_actions_ack = 'write:alerts.actions.ack'
    write_alerts_actions_unack = 'write:alerts.actions.unack'
    ...
    write_notification = 'write:notification'
    admin_notification = 'admin:notification'
    read_notification_history = 'read:notification.history'
    read_notification_channels = 'read:notification.channels'
    write_notification_channels = 'write:notification.channels'
    admin_notification_channels = 'admin:notification.channels'
    read_notification_rules = 'read:notification.rules'
    write_notification_rules = 'write:notification.rules'
    admin_notification_rules = 'admin:notification.rules'
    read_notification_groups = 'read:notification.groups'
    write_notification_groups = 'write:notification.groups'
    admin_notification_groups = 'admin:notification.groups'
    write_notification_sends = 'write:notification.sends'
    ...
    read_emails = 'read:notification.emails'  # Only for reading all emails from users
